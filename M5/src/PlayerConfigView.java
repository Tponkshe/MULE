...
public class PlayerScreen {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 850, 549);
		...
		frame.getContentPane().add(lblMule);
		...
		frame.getContentPane().add(lblMule_1);
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Humanoid", "Ponkshe", "Lall", "Flapper"}));
		...
		lblSelectPlayerColor.setFont(new Font("Times New Roman", Font.PLAIN, 13));
														
		final JComboBox comboBox_1 = new JComboBox();
		comboBox_1.setBounds(163, 79, 130, 20);
		panel.add(comboBox_1);
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"Red", "Blue", "Green", "Yellow", "Pink", "Orange", "Cyan", "Maroon"}));
		...
		JLabel lblNewLabel_1 = new JLabel(" \u00A9 Shyamak Aggarwal, Tanay Ponkshe, Nikhil Karajgikar, Jerry Yee & Ishaan Grover ");
		...
		comboBox_2.setModel(new DefaultComboBoxModel(new String[] {"Humanoid", "Ponkshe", "Lall", "Flapper"}));
		...
		comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"Red", "Blue", "Green", "Yellow", "Pink", "Orange", "Cyan", "Maroon"}));
		...
		label_8.setBounds(10, 46, 121, 14);
									                                              panel_4.add(label_8);
																																...
																																comboBox_4.setModel(new DefaultComboBoxModel(new String[] {"Humanoid", "Ponkshe", "Lall", "Flapper"}));
																																...
																																comboBox_5.setModel(new DefaultComboBoxModel(new String[] {"Red", "Blue", "Green", "Yellow", "Pink", "Orange", "Cyan", "Maroon"}));
																																...
																																comboBox_6.setModel(new DefaultComboBoxModel(new String[] {"Humanoid", "Ponkshe", "Lall", "Flapper"}));
																																...
																																comboBox_7.setModel(new DefaultComboBoxModel(new String[] {"Red", "Blue", "Green", "Yellow", "Pink", "Orange", "Cyan", "Maroon"}));
