...
public class PlayerConfigPanel extends JPanel
{
	...
	// STEP 1: IMPLEMENT GETTER FOR THE TEXT FIELD YOU WANT TO PASS
	// THIS FIELD MUST BE AN INSTANCE VARIABLE IF IT IS NOT
	...
	public PlayerConfigPanel(int numPlayers)
	{
		...
		lblSelectPlayerName.setFont( new Font( "Times New Roman", Font.PLAIN,
				13 ) );
		...
		lblSelectPlayerRace.setFont( new Font( "Times New Roman", Font.PLAIN,
				13 ) );
		...
		lblSelectPlayerColor.setFont( new Font( "Times New Roman", Font.PLAIN,
				13 ) );
		...
		comboBox_1
				.setModel( new DefaultComboBoxModel( new String[] { "Red",
						"Blue", "Green", "Yellow", "Pink", "Orange", "Cyan",
						"Maroon" } ) );
